...
public class Mercader extends Vendedor {
    public Mercader(String nombreComprador, List<Item> inventario, String ciudad, double impuesto, double porcentajeDesgaste) {
        super(nombreComprador, inventario, ciudad, 0.04, 0);
    }
